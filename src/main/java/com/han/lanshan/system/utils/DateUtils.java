...
public class DateUtils {
	...
	public static String getChineseWeek(int date) {
...
//	  System.out.println(getMinDateTimeForToDay());
	...
	/**
	 * 获取一天的开始时间,例如:当前时间是2019-08-07 12:12:12	返回的格式为	2019-08-07 00:00:00
	 * 描述：   
	 * 创建时间：2019年8月7日 下午3:39:04   
	 * 修改时间：2019年8月7日 下午3:39:04
	 * 修改备注：   
	 * @param date
	 * @return
	 * @version
	...
	/**
	 * 获取一天的结束时间,例如:当前时间是2019-08-07 12:12:12	返回的格式为	2019-08-07 23:59:59
	 * 描述：   
	 * 创建时间：2019年8月7日 下午3:40:25   
	 * 修改时间：2019年8月7日 下午3:40:25
	 * 修改备注：   
	 * @param date
	 * @return
	 * @version
	...
	public static int getMaxDayByYearMonth(int year, int month){
		Calendar calendar = getDate(year, month, 0);
		return calendar.getActualMaximum(Calendar.DATE);
	}
	
	public static int getMaxDayByCurrent(){
		Calendar calendar = Calendar.getInstance();
		return calendar.getActualMaximum(Calendar.DATE);
	}
	
	public static int getDayByCurrent(){
		Calendar calendar = Calendar.getInstance();
	    ...
	    if(from == null){
	        ...
	        if(year < 1){// 小于一岁要精确到月份和天数
	        	...
	        	if(from_day<to_day) {
	        		...
	        		day=getMaxDayByYearMonth(to_year,to_month-1)-from_day+to_day;
	        	}
	        }
	        /*if(year > 1){
	        	age = age + year + "岁";
	 ...
	 * @throws Exception
	 */
	public static int betweenDays(Date d1,Date d2)throws Exception{
		long cha = d2.getTime() - d1.getTime();
		int fixed = 24 * 60 * 60 * 1000;// 一天的毫秒数
		int days = (int) (cha % fixed == 0 ? cha / fixed : (cha / fixed + 1));
		return days;
	}
}
