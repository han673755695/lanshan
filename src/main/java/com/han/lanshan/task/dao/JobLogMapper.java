...
public interface JobLogMapper {
	 ...
	 * @throws Exception
	 */
	void deleteJobLog(List<String> ids) throws Exception;
	 ...
	 * @throws Exception
	 */
	void saveJobLog(JobLog jobLog) throws Exception;
	 ...
	 * @version
	 */
	void updateActiveJobLog(JobLog jobLog) throws Exception;
