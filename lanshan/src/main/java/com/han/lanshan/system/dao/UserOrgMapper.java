...
public interface UserOrgMapper {
	 ...
	 * @throws Exception
	 */
	void deleteUserOrg(List<String> ids) throws Exception;
	 ...
	 * @throws Exception
	 */
	void saveUserOrg(UserOrg userOrg) throws Exception;
	 ...
	 * @throws Exception
	 */
	void updateUserOrg(UserOrg userOrg) throws Exception;
	 ...
	 * @version
	 */
	void updateActiveUserOrg(UserOrg userOrg) throws Exception;
